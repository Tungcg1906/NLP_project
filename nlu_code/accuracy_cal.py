...
def update_acc_pre_column():
    ...
    # Update values in the 'openie_generlize' column based on conditions
    update_query = """
        UPDATE nlu_table
    ...
    specific_noRelation = (acc_custom_noRelation/14) 
    specific_employedBy = (acc_custom_employedBy/14) 
    specific_managerOf = (acc_custom_managerOf/14) 
    specific_locatedAt = (acc_custom_locatedAt/14) 
    ...
    specific_noRelation_pre = (acc_pretrained_noRelation/14) 
    specific_employedBy_pre = (acc_pretrained_employedBy/14) 
    specific_managerOf_pre = (acc_pretrained_managerOf/14) 
    specific_locatedAt_pre = (acc_pretrained_locatedAt/14) 
